...
- [下载](http://borg.cc.gatech.edu/download.html#download) , [直接下载3.2版本](http://borg.cc.gatech.edu/sites/edu.borg/files/downloads/gtsam-3.2.1.zip)
...
`gtsam/inference/Ordering.cpp`文件中添`#include <boost/serialization/serialization.hpp>`
